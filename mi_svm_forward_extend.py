"""
MI -> SVM -> forward extension pipeline.
- Split train/test (stratified).
- Search top-k by MI on train via CV (SVM scorer).
- Base set = chosen MI top-k.
...
def run(args: argparse.Namespace) -> None:
    ...
    log_path = args.log_file if args.log_file else Path("mi_svm_forward_extend_log.txt")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="MI -> SVM -> forward extension pipeline")
