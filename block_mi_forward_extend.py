"""
Block-wise MI -> union (base) -> forward extension pipeline.
- Split train/test (stratified).
- Partition features into blocks; per block choose top-k by MI (CV over k grid).
...
def run(args: argparse.Namespace) -> None:
    ...
    log_path = args.log_file if args.log_file else Path("block_mi_forward_extend_log.txt")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Block-wise MI union as base -> forward extension")
